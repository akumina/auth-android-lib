...
public class AppAccount {
     ...
     *
     * @param sharedPref the preferences where the account should be written.
     */
     ...
     * previously saved.
     *
     * @param sharedPref the preferences.
     ...
     *
     * @param sharedPref the settings from which the account data should be cleared.
     */
